        ...
        foreach($tours as $tour):
            ...
            <div>        
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="https://wa.me/<?=$data['phone']?>?text=<?=$helpers->format_wa_send(['img' => $tour['img'], 'title' => $tour['title'], 'price' => $tour['price'], 'category' => $category])?>" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Pesan Sekarang</a>
                </div>
            </div>
        </div>
    </div>
