<section id="travel" class="container mx-auto px-4 py-0">
    <div class="flex justify-center mb-12">
        <div>
            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Drop Off Bandara Soekarno Hatta</h3>
        </div>
    </div>
            ...
            <div>        
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="px-2 pb-5 py-6">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white"><?=$travel['title']?></h5>
