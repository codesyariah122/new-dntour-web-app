<style>
    ...
    .fadeInLeft {
        animation: fadeInLeft 10s ease-out;
    }
    ...
    .fadeInRight {
        animation: fadeInRightt 10s ease-out;
    }
</style>
            ...
            <div class="-ml-72">
                <a href="#rental" id="cta-hero" class="hero-cta py-1 px-1 pr-4 mb-7 text-sm text-blue-700 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300 hover:bg-blue-200 dark:hover:bg-blue-800 fadeInLeft">
                    <div class="flex justify-between items-center">
                        <div class="absolute left-0 transform -translate-y-2/2 bg-blue-600 rounded-full text-white px-6 py-1.5 mr-24">
                            <i class="fa-solid fa-van-shuttle fa-1xl"></i>
                        </div>
                        <div>
                            <span id="typing-cta" class="px-16 text-lg font-medium">Selengkapnya &nbsp;&nbsp;<i class="fa-solid fa-angle-down text-lg"></i></span>
                        </div>
                    </div>
                </a>
            </div>
